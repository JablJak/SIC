...
W pracy skupiono się na zachowaniu informacji o rozkładzie pikseli w oryginalnych obrazach, dlatego zrezygnowano z różnorodnych przekształceń danych wejściowych, powszechnych w wielu zadaniach uczonej wizji komputerowej. Nie zastosowano zmian jasności i nasycenia, oraz innych transformacji wpływających na dystrybucję pikseli, ani takich, które wymagałyby interpolacji lub próbkowania, czyli przekształceń zmniejszania, powiększania i rotacji. W praktyce zastosowano jedynie losowe wycinanie próbek z obrazów treningowych oraz ich standaryzację przed wejściem do sieci.
